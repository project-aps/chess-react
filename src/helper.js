...
//copy the position from input and return it
...
//here concept is to check by the coords sum is even/odd if even black tile and if odd white tile
export const areSameColorTiles = (coords1, coords2) =>
    (coords1.x + coords1.y) % 2 === coords2.x + coords2.y;

//it will return all the positions in{x,y} of the type of the piece for e.g. queen type
